...
public class Singleton {
    ...
    /*
    # 싱글톤 디자인패턴: 클래스의 객체를 단 1개를 제한하기 위한 코드 디자인패턴
    ...
    //단하나의 객체의 주소값을 공개된 매서드를 통해 리턴합니다.
    ...
    //////////////////////////////////////////////////////////////
    public void method1() {
        System.out.println("어러군데서 쓰이는 중요한 메서드!");
    }
    
    public void method2(){
        System.out.println("프로그램 내에서 꼭 한 번 불러야하는 귀한 메서드");
    }
}
