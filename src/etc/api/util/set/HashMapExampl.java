...
public class HashMapExampl {
    public static void main(String[] args) {
        ...
        //Map은 key, Value 쌍으로 이루기 떄문에 멀티 제네릭을 설정
        ...
        //만약 중복 Key를 사용하여 put을 호출하면 valye만 수정됩니다.
        map.put("멍멍이", "김뽀삐");
        map.put("어흥이", "홍길동");
        System.out.println("map = " + map);

        //map내부에 key의 존재 유무를 확인하는 메서드: containsKey(key)
...
//        System.out.println(map.get("삐약이"));
        ...
        if (map.containsKey(nick)) {
            ...
            //모든 key들을 set에 담아서 반환합니다. ->반복문 처리가 가능함
